...
Config.IPAddress     = "http://20.195.196.112/"
...
Config.TablePlayerDB = "wave_playerdata" -- nome da vrp_user_data mudar somente se salvar em outro local
Config.Locale        = "br"
...
Config.checkItemPhone = function(source, user_id, item)
    if checkIteminInvetory(user_id, item, 1) then
        ...
        sendnotify(source,"vermelho",_("dont_have_cell"),5000)
        return false
    end
end
