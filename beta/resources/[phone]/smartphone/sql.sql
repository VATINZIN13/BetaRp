...
CREATE TABLE IF NOT EXISTS `smartphone_messages` (
	...
	PRIMARY KEY (`id`) USING BTREE,
	INDEX `smartphone_messages` (`id_chat`) USING BTREE,
	CONSTRAINT `smartphone_messages` FOREIGN KEY (`id_chat`) REFERENCES `smartphone_chats` (`id`) ON UPDATE RESTRICT ON DELETE RESTRICT
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
