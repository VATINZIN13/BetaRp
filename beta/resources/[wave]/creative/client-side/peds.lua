...
local pedList = {
	...
	{ -- Favela01
		distance = 10,
		coords = { 1398.2,-188.54,161.56,53.86 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Favela02
		distance = 10,
		coords = { 2248.69,50.33,251.42,243.78 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- DaNang
	...
	{ -- Favela03
		distance = 10,
		coords = { 1707.5,447.59,232.83,235.28 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Imobiliária
	...
	{ -- Imobiliária2
		distance = 100,
		coords = { -308.04,-163.96,40.42,235.28 },
		model = { 0x3AE4A33B,"ig_fbisuit_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Favela04
		distance = 10,
		coords = { 2996.62,3036.7,105.73,127.56 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Favela05
		distance = 10,
		coords = { -164.76,3211.75,51.78,297.64 },
		model = { 0xE52E126C,"ig_ramp_gang" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Departament Store
