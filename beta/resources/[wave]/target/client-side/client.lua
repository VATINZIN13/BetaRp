...
Citizen.CreateThread(function()
	...
	AddCircleZone("polService01",vector3(-813.7,-1237.1,6.86),0.75,{
		name = "polService01",
		heading = 317.49
	},{
		distance = 1.0,
	...
	AddCircleZone("paraService03",vector3(1137.35,-1546.52,35.38),0.75,{
		name = "paraService03",
		heading = 0.0
	},{
		distance = 1.0,
	...
	AddCircleZone("mecService01",vector3(-28.37,-1049.49,28.39),0.75,{
		name = "mecService01",
		heading = 249.45
	},{
		distance = 1.0,
	...
	AddCircleZone("mecService02",vector3(1157.19,-778.64,57.61),0.75,{
		name = "mecService02",
		heading = 266.46
	},{
		distance = 1.0,
	...
	AddCircleZone("treatment03",vector3(1139.83,-1536.81,35.38),0.75,{
		name = "treatment03",
		heading = 136.07
	},{
		distance = 1.25,
	...
	AddTargetModel({ 1885839156 },{
		options = {
			{
				event = "inventory:verifyBox",
				label = "Vasculhar",
				tunnel = "police",
				service = "LootBox"
			}
	...
	AddTargetModel({ 538990259 },{
		options = {
			{
				event = "works:ShockzCreate",
				label = "Produzir",
				tunnel = "server"
			},{
				event = "props:DeleteMethTable",
				label = "Remover",
				tunnel = "client"
			}
		},
	...
	AddTargetModel({ 1030147405 },{
		options = {
			{
				event = "crafting:craftCoins",
				label = "Binance",
				tunnel = "client"
			},{
				event = "props:DeleteCoinsMachine",
				label = "Remover",
				tunnel = "client"
			}
		},
	...
	AddCircleZone("coffeCup",vector3(123.97,-1036.73,29.27),0.5,{
		name = "coffeCup",
		heading = 252.29
	},{
		distance = 1.25,
	...
	AddCircleZone("coffeFood",vector3(122.19,-1038.72,29.27),0.5,{
		name = "coffeFood",
		heading = 73.71
	},{
		distance = 1.35,
	...
	AddCircleZone("coffeBox",vector3(123.26,-1035.86,29.27),0.5,{
		name = "coffeBox",
		heading = 79.38
	},{
		distance = 1.25,
	...
	AddCircleZone("divingStore",vector3(2769.04,1393.05,24.53),0.5,{
		name = "divingStore",
		heading = 235.28
	},{
		distance = 1.0,
					...
					elseif IsEntityAVehicle(entity) then
						if #(coords - entCoords) <= 1.0 then
							...
							if policeService then
								...
								local distance01 = #(coords - vector3(603.21,-430.44,24.74))
								local distance02 = #(coords - vector3(257.06,2578.03,45.21))
